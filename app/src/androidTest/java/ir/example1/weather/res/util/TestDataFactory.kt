package ir.example1.weather.res.util
...
object TestDataFactory {
    ...
    fun weatherEntity(cityId: Long = 1L, temp: Double = 25.0) = WeatherEntity(
        cityId = cityId,
        temperature = temp,
        description = "Clear",
        icon = "01d",
    ...
    fun forecastEntity(cityId: Long = 1L,temp: Double = 20.0) = ForecastEntity(
        temperature = temp,
        description = "Cloudy",
        icon = "02d",
        cityId = cityId,
